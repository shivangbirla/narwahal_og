  ...
  return (
    <>
      <div className="bg-[#F8F9FA]">
        <h2 className="text-[20px] font-medium mb-6">Check Out</h2>
        <div className="flex flex-row text-[16px] font-medium bg-[#FFF] max-w-[352px] w-auto cursor-pointer rounded-t-2xl">
          {tabs.map((tab, index) => (
            <div
              className={cn(
